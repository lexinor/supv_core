...
Config.Traffic = {
    ...
    dispatch = { -- https://docs.fivem.net/natives/?_0xDC0F817884CDD856 -- enable = true (default) active dispatch / false to desactivate dispatch
        ...
        army = {enable = false, list = {14}}, -- enable = true (default) active dispatch / false to desactivate dispatch
        ambulance = {enable = false, list = {5,3}}, -- & FireDepartement -- enable = true (default) active dispatch / false to desactivate dispatch
        gang = {enable = false, list = {11,15}}, -- enable = true (default) active dispatch / false to desactivate dispatch
        unknow = {enable = false, list = {0}} -- enable = true (default) active dispatch / false to desactivate dispatch
    },
}
